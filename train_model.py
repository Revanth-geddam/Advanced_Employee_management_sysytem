...
message = tk.Label(window, text="Face Recognizer", bg="cyan", fg="black", width=50,
...
takeImg = tk.Button(window, text="Take Images", command=take_img, fg="black", bg="blue", width=20, height=3,
                    activebackground="Red", font=('times', 20, 'italic bold '))
takeImg.place(x=200, y=500)

trainImg = tk.Button(window, text="Train Images", fg="black", command=trainimg, bg="blue", width=20, height=3,
                     activebackground="Red", font=('times', 20, 'italic bold '))
